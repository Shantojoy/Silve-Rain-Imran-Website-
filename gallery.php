...
<div class="row g-4"><?php foreach($items as $item): ?><div class="col-lg-6"><div class="card p-3 shadow-sm before-after"><h5><?= htmlspecialchars($item['title']); ?> <span class="badge bg-secondary"><?= htmlspecialchars($item['category_name'] ?? ''); ?></span></h5><div class="row g-2"><div class="col-6"><small>Before</small><img src="uploads/gallery/<?= htmlspecialchars($item['before_image']); ?>" alt="before"></div><div class="col-6"><small>After</small><img src="uploads/gallery/<?= htmlspecialchars($item['after_image']); ?>" alt="after"></div></div></div></div><?php endforeach; ?></div>
