...
<div class="collapse <?= in_array($currentFile,['settings.php','email-templates.php'])?'show':''; ?>" id="menuSettings"><a href="settings.php" class="admin-sublink">General Settings</a><a href="settings.php#invoice-settings" class="admin-sublink">Invoice Settings</a><a href="settings.php" class="admin-sublink">Email & SMTP</a><a href="email-templates.php" class="admin-sublink">Advanced Templates</a></div>
</div>
<div class="p-2 border-top"><button class="btn btn-outline-secondary w-100 btn-sm" id="sidebarToggle"><i class="bi bi-list"></i> <span class="menu-text">Menu</span></button></div>
</aside>
