...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['order_id'])) {
    ...
    if (in_array($status, $allowed, true)) {
        ...
        if ($orderData) sendTemplateEmail($pdo, 'order_status_updated', $orderData['email'], ['customer_name'=>$orderData['name'],'order_status'=>$status,'order_id'=>$orderId,'product_name'=>'']);
